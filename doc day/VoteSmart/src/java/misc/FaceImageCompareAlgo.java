 ...
 * @author ankur
 */
public class FaceImageCompareAlgo {
    ...
    public static boolean compare(String path1,String path2) {
        ...
        FaceImageCompareAlgo ic = new FaceImageCompareAlgo(path1, path2);
    ...
    public FaceImageCompareAlgo(String file1, String file2) {
        this(loadJPG(file1), loadJPG(file2));
    }

    // constructor 2. use awt images.
    public FaceImageCompareAlgo(Image img1, Image img2) {
    ...
    public FaceImageCompareAlgo(BufferedImage img1, BufferedImage img2) {
        this.img1 = img1;
        this.img2 = img2;
        autoSetParameters();
    }
